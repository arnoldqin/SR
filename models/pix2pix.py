...
#        networks.print_network(self.netG_B, opt, (opt.input_nc, opt.fineSize, opt.fineSize))
    ...
    def backward_D_A_sr(self):
        ...
        if self.opt.lambda_gp > 0:
            ...
            self.loss_D_A_real, self.loss_D_A_sr_fake = self.backward_D_basic(self.netD_A, self.real_B, fake_B_sr)
	...
	# aux loss
      ...
      #          self.loss_aux_G_A += self.loss_color_A
        ...
        # combined loss
	self.loss_G_l1 = self.criterionCycle(self.fake_B, self.real_B) * self.opt.lambda_AE_A
	...
	AE = self.loss_AE.item()
        ret = OrderedDict([('D_A_real', D_A_real), ('D_A_fake', D_A_fake), ('G_A', G_A), 
                           ('AE', AE)])
	...
	self.fake_C_l = self.netE_C.forward(self.real_C)
        ...
        return OrderedDict([('real_A', real_A), ('fake_B', fake_B), ('real_B', real_B), ('real_C', real_C), ('fake_C', fake_C),('real_C_test', real_C), ('fake_C_l', fake_C_l), ('real_A_test', real_A), ('fake_A_h', fake_A_h)])
